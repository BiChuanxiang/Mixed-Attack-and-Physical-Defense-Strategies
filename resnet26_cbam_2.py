...
class BasicBlock(nn.Module):
    ...
    def __init__(self, inplanes, planes, stride=1, downsample=None):
        ...
        self.bn3 = nn.BatchNorm2d(planes)  # 使用nn.BatchNorm2d作为标准化层
        self.conv4 = nn.Conv2d(planes, planes, kernel_size=3, stride=1, padding=1)
        self.bn4 = nn.BatchNorm2d(planes)  # 使用nn.BatchNorm2d作为标准化层
...
def resnet26_cbam(pretrained=False, **kwargs):
